...
class BlogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'feature' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2017-05-18 07:30:11',
            'modified' => '2017-05-18 07:30:11',
            'feature' => 1
        ],
    ];
}
